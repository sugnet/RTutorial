...
::: {style="color: #80CC99;"}
(a)	Check which (if any) of the states in the `state.x77` data set have populations with an illiteracy rate that is not larger than $1.6$ and a Murder rate of more than $10.0$. 
...
(b)	Find the 5% trimmed mean for Illiteracy of the states in the `state.x77` data set. *Hint*: `?mean` provides help for the function `mean()`.
