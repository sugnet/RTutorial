...
```{r, coordinates, echo=FALSE, fig.cap="Cartesian and polar coordinates for referencing a point on a graph.", out.width="100%"}
library(knitr)
knitr::include_graphics("pics/coordinates.jpg")
```
